    ...
    if any(evolProg==(i+its))
        if verbose
            ...
            fprintf('Evolution Progress > %3d%% iteration: %3d \t best fitness: %4.3f \t iter fitness: %4.3f \n', ...
                prog, i+its, to_max*Jbest, to_max*Jtest);
...
if nout > 0, varargout(1) = {best}; end
if nout > 1, varargout(2) = {allbest}; end
if nout > 2, varargout(3) = {solution}; end
